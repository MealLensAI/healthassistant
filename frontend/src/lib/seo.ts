...
export const ROUTE_SEO: Record<string, Partial<MetaConfig>> = {
    ...
    '/payment': {
        title: 'Subscribe – MealLensAI | Plans from $10/month',
        description: 'Get one free 7-day meal plan, then choose 1 Month ($10), 6 Months ($120), or 1 Year ($240). Cancel anytime.'
    },
    '/profile': {
    ...
    try {
        ...
        if (!document.getElementById(orgId)) {
            ...
            script.text = JSON.stringify({
                ...
                description: 'AI-powered recipe finder and meal planning for chronic conditions. Plans from $10/month after free meal plan.',
        ...
        if (!document.getElementById(siteId)) {
            ...
            script.text = JSON.stringify({
                ...
                name: 'MealLensAI',
                url: baseUrl,
                description: 'Snap ingredients, get recipes. AI meal plans for diabetes, hypertension, PCOS and more. One free 7-day meal plan, then plans from $10/month.',
                potentialAction: {
                    '@type': 'SearchAction',
        ...
        if (!document.getElementById(appId)) {
            ...
            script.text = JSON.stringify({
                ...
                operatingSystem: 'Web',
                url: baseUrl,
                description: 'AI ingredient recognition, step-by-step recipes, and personalized 7-day meal plans for chronic conditions. Budget and location-based plans. One free 7-day meal plan, then plans from $10/month.',
                offers: {
                    '@type': 'Offer',
                    price: '20',
                    priceCurrency: 'USD',

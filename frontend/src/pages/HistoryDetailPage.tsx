      ...
      <div className="fixed top-0 right-0 bottom-0 left-0 md:left-[250px] bg-white z-50 flex items-center justify-center px-4">
        <div className="text-center">
          ...
          <button
            ...
            className="px-4 sm:px-6 py-2 sm:py-3 bg-primary text-white rounded-[12px] sm:rounded-[15px] font-semibold hover:bg-blue-deep transition-colors text-sm sm:text-base"
          >
            Back to History
          </button>
        </div>
      ...
      <div className="fixed top-0 right-0 bottom-0 left-0 md:left-[250px] bg-white z-50 overflow-hidden flex flex-col">
        ...
        <header className="px-4 sm:px-6 md:px-8 h-[70px] sm:h-[80px] md:h-[88px] flex items-center border-b bg-card border-b border-border">
          <div className="flex items-center justify-between w-full gap-2 sm:gap-4">
            ...
            {/* Profile Button */}
            <button className="flex items-center h-[36px] sm:h-[40px] md:h-[48px] gap-1.5 sm:gap-2 md:gap-3 px-2 sm:px-3 md:px-5 rounded-full border border-border bg-card hover:bg-secondary transition-colors flex-shrink-0">
                  ...
                  {youtubeVideos.map((video) => (
                    ...
                    >
                      ...
                      <div className="p-4">
                        ...
                        <button
                          onClick={() => video.videoId && setSelectedVideo(video.videoId)}
                          className="w-full h-[44px] rounded-[12px] text-[14px] font-medium bg-white text-primary border border-primary hover:bg-primary hover:text-white transition-all duration-200"
                        >
                          Watch Tutorial
                        </button>
                      </div>
                    ...
                    >
                      ...
                      <div className="p-4">
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="flex items-center justify-center w-full h-[44px] rounded-[12px] text-[14px] font-medium bg-white text-primary border border-primary hover:bg-primary hover:text-white transition-all duration-200"
                        >
                          Read Article
                        </a>
                      </div>
